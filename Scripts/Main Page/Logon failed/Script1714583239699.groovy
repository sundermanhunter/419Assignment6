...
WebUI.click(findTestObject('Object Repository/Page_Result Form/legend_Credit Information'))

WebUI.verifyElementNotPresent(findTestObject('Page_Result Form/label_Card Holder'), 1)
